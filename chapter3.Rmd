...
The relationship between failure and alc_use, we can find that alc_use statictically significant with the variable failures (0,003). This means that alc_use is explained to some extent by how much the individual fails in school. 

From this output, we can find that for every more failure, the alcohol consumption will increace by 0,2. 
...
From this image and output, we can conclude that there is a statistically significant relationship between the variable alc_use and famrel (0,018). This means that the difference in alc_use can to some extent be explained by the variable famrel. 

From the output we can find that for every one step on the famrel scale, the alcohol use reduces by 0,13. This is also what my hypothesis claimed. 
...
The relationship between the alc_use and goout variable is statistically significant (0.000). This means that the goout variable can to some extent explain the variation in the alc_use variable. This translates to an increase of 0,34 to alc_use when the goout variable increaces by one. 
